...
<script>
	...
	export default {
		...
		created: function() {
			...
			console.log('%c EasyUI %c Gitee: https://gitee.com/lolicode/scui', 'background:#666;color:#fff;border-radius:3px;', '')
		},
		methods: {
			configDark(){
			...
			wechatLogin(){
				...
				this.WechatLoginCode = "EasyUI-823677237287236-" + new Date().getTime()
